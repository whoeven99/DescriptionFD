...
import { getProductsByListId } from "app/api/JavaServer";
...
const Index = () => {
  ...
  const handleNextPage = () => {
    fetcher.submit(
      { query: queryValue, pageSize: 50, endCursor: pagination.endCursor },
      { method: "POST", action: "/getProductInfo" },
    );
  };
  ...
  const handlePreviousPage = () => {
    fetcher.submit(
      { query: queryValue, pageSize: 50, startCursor: pagination.startCursor },
      { method: "POST", action: "/getProductInfo" },
    );
  };
  ...
  return (
    ...
    >
      <Layout>
        <Layout.Section>{/* <h1>Batch Generation</h1> */}</Layout.Section>
        <Layout.Section>
